...
print('clf_name=', clf_name, "random_state=", random_state)
...
if clf_name == "svm":
    h_param_comb = {"svm": svm_h_param_comb}
if clf_name == "tree":
    h_param_comb = {"decision_tree": dec_h_param_comb}
...
for n in range(n_cv):
    ...
    x_train, x_dev_test, y_train, y_dev_test = train_test_split(
        data, label, test_size=dev_test_frac, shuffle=True, random_state=int(random_state)
    )
    x_test, x_dev, y_test, y_dev = train_test_split(
        x_dev_test, y_dev_test, test_size=(dev_frac) / dev_test_frac, shuffle=True, random_state=int(random_state)
    )
